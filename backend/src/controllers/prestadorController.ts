...
/**
 * Interface com os campos esperados no corpo da requisição de cadastro
 */
...
/**
 * Interface com os parâmetros aceitos na query de busca filtrada
 */
interface IBuscaQuery {
  cidade?: string;
  estado?: string;
  profissao?: string;
  pagina?: string;
 ...
 */
export const cadastrarPrestador = async (req: Request<{}, {}, ICadastroBody>, res: Response): Promise<Response> => {
  try {
 ...
 */
export const buscarPrestadores = async (req: Request<{}, {}, {}, IBuscaQuery>, res: Response): Promise<Response> => {
  try {
